...
VALUES ('Augmon', '2020-02-03', '0', true, 10.23);
...
-- modify owners_id
BEGIN;
UPDATE animals SET owners_id = 1 WHERE name IN('Augmon');
...
VALUES('William Tatcher', 45, '2000-03-23'),
...
VALUES((SELECT animalid FROM animals WHERE name = 'Augmon'), (SELECT id FROM vets WHERE name = 'William Tatcher'), '2020-05-24'),
((SELECT animalid FROM animals WHERE name = 'Augmon'), (SELECT id FROM vets WHERE name = 'Stephanie Mendez'), '2020-07-22'),
